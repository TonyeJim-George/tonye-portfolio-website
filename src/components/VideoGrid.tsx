...
const VideoSlider: React.FC = () => {
  ...
  const videos = [
    "images/VIDEOGRAPHY PORTFOLIO/MY PROJECTS (LANDSCAPE)/RESCUE SHOWREEL.mp4",
    "images/VIDEOGRAPHY PORTFOLIO/MY PROJECTS (LANDSCAPE)/Confused trailer.mp4",
    "images/VIDEOGRAPHY PORTFOLIO/MY PROJECTS (LANDSCAPE)/Girly_s wedding for my portfolio.mp4",
    "images/VIDEOGRAPHY PORTFOLIO/MY PROJECTS (LANDSCAPE)/AMVCA multichoice talent factory.mp4",
    "images/VIDEOGRAPHY PORTFOLIO/MY PROJECTS (LANDSCAPE)/RESCUE (Behind The Scenes) Part 1.mp4",
    "images/VIDEOGRAPHY PORTFOLIO/MY PROJECTS (LANDSCAPE)/Copy of Fubby_s trad wedding.mov",
  ];
